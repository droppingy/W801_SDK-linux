...
if [ $signature -eq 1 ]
 then
  ...
  ../../../../../../../tools/w800/wm_tool.exe -b ../../../../../../../tools/w800/w800_secboot.bin -o ../../../../../../../tools/w800/w800_secboot -it 0 -fc 0 -ra $sec_img_pos -ih $sec_img_header -ua $upd_img_pos -nh $run_img_header  -un 0    
...
if [ $zip_type -eq 1 ]
 then
  if [ $signature -eq 1 ]
   then
    ../../../../../../../tools/w800/wm_tool.exe -b ./"$ProjName"_sign.img -o ../../../../../../../bin/w800/"$ProjName"_sign -it $img_type -fc 1 -ra $run_img_pos -ih $run_img_header -ua $upd_img_pos -nh 0  -un 0
