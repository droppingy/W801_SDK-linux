...
tls_bt_status_t tls_bt_spp_connect(wm_spp_sec_t sec_mask,tls_spp_role_t role,uint8_t remote_scn,tls_bt_addr_t * bd_addr)
{
	CHECK_BTSPP_INIT();
	btif_spp_cb_t btif_cb;
...
tls_bt_status_t tls_bt_spp_start_server(wm_spp_sec_t sec_mask,tls_spp_role_t role,uint8_t local_scn,const char * name)
{
	CHECK_BTSPP_INIT();
	btif_spp_cb_t btif_cb;
    btif_cb.sec_mask = sec_mask;
